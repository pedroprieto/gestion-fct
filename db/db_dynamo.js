  ...
  try {
    var params = {
      ...
      KeyConditionExpression:
        "usuCursoPeriodo= :usuCursoPeriodo and begins_with(SK, :SK)",
    };
...
function updateVisita(usuCursoPeriodo, fctId, tipo, visita) {
  var params = {
    ...
    UpdateExpression:
      "set distancia = :distancia, fecha = :fecha, hora_salida = :hora_salida, hora_regreso = :hora_regreso, localidad = :localidad, impresion = :impresion, presencial = :presencial",
    ExpressionAttributeValues: {
